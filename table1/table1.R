...
df_freq <- data.frame(sample_size = rep(c("$n=100$","$n=200$"),each=4),
                      parameter = rep(c("$\\theta$",
                                        "$\\sigma_1$",
                                        "$\\sigma_2$",
                                        "$w_1$"),2),
                      MLE = c(mean(df_em_100$loc),
                              ...
                              mean(df_em_200$w1)),
                      hat.s.d. = c(mean(df_em_100$loc_se),
                      ...
                      mc.se = c(sqrt(var(df_em_100$loc_se)/1000),
                      ...
                      s.d.1 = c(sd(df_em_100$loc),
                                ...
                                sd(df_em_200$scale2),
                                sd(df_em_200$w1)),
                      bayes.mean = c(mean(df_bayes_100$loc),
                      ...
                      bayes.s.d. = c(mean(df_bayes_100$loc_se),
                      ...
                      bayes.mc.se = c(sqrt(var(df_bayes_100$loc_se)/1000),
